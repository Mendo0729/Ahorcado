...
Aplicacion web moderna de Ahorcado creada con Node.js, Express, HTML5, CSS3 y JavaScript Vanilla. Incluye ranking local, estadisticas por jugador, temporizador, tema claro/oscuro, sonidos generados en el navegador y una base de palabras por constructos psicologicos.
